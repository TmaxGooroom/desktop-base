...
build-logos clean-logos install-logos:
	...
	$(MAKE) $$target -C tmaxgooroom-logos || exit 1;
...
install-local:
	...
	# Create a 'tmaxgooroom-theme' symlink in plymouth themes folder, pointing at the
	# plymouth theme for the currently active 'desktop-theme' alternative.
	mkdir -p $(DESTDIR)/usr/share/plymouth/themes
	ln -s ../../desktop-base/active-theme/plymouth $(DESTDIR)/usr/share/plymouth/themes/tmax-theme
	...
	# tmaxgooroom theme (Buster’s default)
	install -d $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme

	### Login background
	install -d $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/login
	$(INSTALL_DATA) $(wildcard tmaxgooroom-theme/login/*) $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/login

	### Wallpapers
	install -d $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/wallpaper/contents/images
	$(INSTALL_DATA) tmaxgooroom-theme/wallpaper/metadata.desktop $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/wallpaper
	$(INSTALL_DATA) tmaxgooroom-theme/wallpaper/gnome-background.xml $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/wallpaper
	$(INSTALL_DATA) $(wildcard tmaxgooroom-theme/wallpaper/contents/images/*) $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/wallpaper/contents/images/
	$(INSTALL_DATA) tmaxgooroom-theme/gnome-wp-list.xml $(DESTDIR)/usr/share/gnome-background-properties/debian-tmaxgooroom.xml
	# Wallpaper symlink for KDE
	install -d $(DESTDIR)/usr/share/wallpapers
	cd $(DESTDIR)/usr/share/wallpapers && ln -s /usr/share/desktop-base/tmaxgooroom-theme/wallpaper TmaxGooroom

	### Lockscreen is using the same image as wallpaper
	install -d $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/lockscreen/contents/images
	$(INSTALL_DATA) tmaxgooroom-theme/wallpaper/metadata.desktop $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/lockscreen
	$(INSTALL_DATA) tmaxgooroom-theme/wallpaper/gnome-background.xml $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/lockscreen
	$(INSTALL_DATA) $(wildcard tmaxgooroom-theme/wallpaper/contents/images/*) $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/lockscreen/contents/images/

	### Alternate wallpaper with Debian swirl
	install -d $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/wallpaper-withlogo/contents/images
	$(INSTALL_DATA) tmaxgooroom-theme/wallpaper-withlogo/metadata.desktop $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/wallpaper-withlogo
	$(INSTALL_DATA) tmaxgooroom-theme/wallpaper-withlogo/gnome-background.xml $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/wallpaper-withlogo
	$(INSTALL_DATA) $(wildcard tmaxgooroom-theme/wallpaper-withlogo/contents/images/*) $(DESTDIR)/usr/share/desktop-base/tmaxgooroom-theme/wallpaper-withlogo/contents/images/
	# Lock screen symlink for KDE
	install -d $(DESTDIR)/usr/share/wallpapers
	cd $(DESTDIR)/usr/share/wallpapers && ln -s /usr/share/desktop-base/tmaxgooroom-theme/wallpaper-withlogo TmaxGooroomWithLogo
